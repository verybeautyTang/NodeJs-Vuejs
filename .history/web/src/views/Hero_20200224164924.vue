  ...
  <div class="hero_list">
    ...
    <div class="hero_bg" :style="{'background-image':`url(${hero.banner})`}">
      <div class="hero_title">
        ...
        <div class="skill">
          <span>难度</span>
          <div class="skills ">{{model.scores.difficult}}</div>
          <span>技能</span>
          <div class="skills ">{{model.scores.skills}}</div>
          <span>攻击</span>
          <div class="skills ">{{model.scores.attack}}</div>
          <span>生存</span>
          <div class="skills ">{{model.scores.survive}}</div>
        </div>
      </div>
    </div>
  </div>
