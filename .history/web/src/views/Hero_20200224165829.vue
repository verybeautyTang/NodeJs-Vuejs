    ...
    <div class="hero_bg" :style="{'background-image':`url(${hero.banner})`}">
      <div class="hero_title">
        ...
        <div class=" d-flex text-white">
          <span>难度</span>
          <div class="skills px-2 bg-info">{{hero.scores.difficult}}</div>
          <span>技能</span>
          <div class="skills px-2 bg-blue_1">{{hero.scores.skills}}</div>
          <span>攻击</span>
          <div class="skills px-2 bg-red">{{hero.scores.attack}}</div>
          <span>生存</span>
          <div class="skills px-2 bg-green">{{hero.scores.survive}}</div>
        </div>
      </div>
    </div>
  </div>
