    ...
    <div class="hero_bg" :style="{'background-image':`url(${hero.banner})`}">
      <div class="hero_title">
        ...
        <div class=" d-flex text-white">
          <span>难度</span>
          <div class="skills  p-2">{{hero.scores.difficult}}</div>
          <span>技能</span>
          <div class="skills  p-2">{{hero.scores.skills}}</div>
          <span>攻击</span>
          <div class="skills  p-2">{{hero.scores.attack}}</div>
          <span>生存</span>
          <div class="skills  p-2">{{hero.scores.survive}}</div>
        </div>
      </div>
    </div>
  </div>
