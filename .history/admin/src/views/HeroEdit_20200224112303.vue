<template>
  <el-form label-width="120px" @submit.native.prevent="save">
    ...
    <el-tabs type='border-card' value='basic'>
      ...
      <el-tab-pane label='英雄关系' name='addPatner'>
        <el-tabs type='border-card' value='addHero'>
          <el-tab-pane label='英雄关系' name='addHero'>
            <el-tab-pane label='最佳搭档' name='addPatner'></el-tab-pane>
            <el-tab-pane label='最佳搭档' name='addPatner'></el-tab-pane>
            <el-button type='text' size='small'  @click="model.skills.push({})"><i class="el-icon-plus"></i> 添加技能</el-button>
            <el-row type="flex" class="row-bg" style="flex-wrap:wrap">
            <el-col :md="12"  v-for="(item, i) in model.skills" :key="i">
